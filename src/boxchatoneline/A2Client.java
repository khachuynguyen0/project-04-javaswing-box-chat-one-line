...
public class A2Client extends javax.swing.JFrame {
    //B2-Bien cuc bo
    ...
    private static final java.util.logging.Logger logger = java.util.logging.Logger.getLogger(A2Client.class.getName());
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(() -> new A2Client().setVisible(true));
    }
