...
public class A1ServerChuyenText extends javax.swing.JFrame {
    ...
    private static final java.util.logging.Logger logger = java.util.logging.Logger.getLogger(A1ServerChuyenText.class.getName());

    public A1ServerChuyenText() {
        initComponents();
    }
    ...
    private void btnActionActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnActionActionPerformed
        ...
        try{
            ...
            //Gui ND for Client
            String textOfServer=txtSend.getText();
            out.println(textOfServer);
            System.out.println("Server: Da gui 1 tin nhan");
            //xoa nd Send
            CleanTxtSend();
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(() -> new A1ServerChuyenText().setVisible(true));
    }
